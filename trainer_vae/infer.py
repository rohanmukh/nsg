...
class BayesianPredictor(object):
    ...
    def get_api_prob_from_next_batch(self, loader_batch, visibility=1.00):
        ...
        [concept_prob, api_prob, type_prob, clstype_prob, var_prob, op_prob, method_prob] \
        ...
        return concept_prob, api_prob, type_prob, clstype_prob, var_prob, op_prob, method_prob


    def get_horizon_prob_from_next_batch(self, loader_batch, visibility=1.00, ignore_concepts=True):
        nodes, edges, targets, var_decl_ids, ret_reached, \
        node_type_number, \
        type_helper_val, expr_type_val, ret_type_val, \
        all_var_mappers, iattrib, \
        ...
        prob_dict = self.model.get_horizon_probs(self.sess,
                        nodes, edges, targets, var_decl_ids, ret_reached, \
                        node_type_number, \
                        type_helper_val, expr_type_val, ret_type_val, \
                        all_var_mappers, iattrib, \
                        apis, types, kws,
                        ret_type, fp_in, fields, method, classname, javadoc_kws,
                        surr_ret, surr_fp, surr_method, visibility=visibility, ignore_concepts=ignore_concepts,
                        )
