...
from program_helper.ast.ops import Node, DType, DSymtabMod, DVarAccessDecl
...
class DVarDecl(Node):
    def __init__(self, node_js=None, symtab=None, child=None, sibling=None):
        ...
        self.child.sibling = DType(self.var_type)
        self.child.sibling.sibling = DSymtabMod(0, type_helper=self.var_type)
