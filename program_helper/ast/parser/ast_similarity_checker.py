...
class AstSimilarityChecker:
    ...
    def print_stats(self):
        ...
        self.logger.info('')
        avg_apicalls = self.num_api_calls / (self.num_api_calls_count + 0.00001)
        self.logger.info('\tAverage number of apicalls :: {0:0.4f}'.format(avg_apicalls))
