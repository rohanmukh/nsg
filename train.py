...
from trainer_vae.utils import read_config, dump_config, construct_minibatch
...
def train(clargs):
    ...
    config_file = os.path.join(clargs.continue_from, 'config_nag.json') \
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save', type=str, default='save_nag',
