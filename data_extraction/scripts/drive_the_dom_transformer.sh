...
rm -r data_transformer
mkdir data_transformer
...
python3 -u /home/ubuntu/grammar_vae/data_extraction/scripts/extract_transformer_data_raw.py $filename_parsed --output_folder temp_data
