...
public class BatchDriver {
    ...
    public static void main(String args[]) throws IOException, InterruptedException {
        ...
        while ((file = br.readLine()) != null) {
            ...
            String[] file_bits = file.split("/");
            String out_file_name = "JSONFiles/" + String.join("_", file_bits) + ".json";
            //String out_file_name = file + ".json";
            String[] driverArgs = { "-f", file, "-c", configFile, "-o", out_file_name };
