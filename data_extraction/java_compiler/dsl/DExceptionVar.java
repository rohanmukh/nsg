...
public class DExceptionVar extends DASTNode
{

    //TODO: public class InvalidVARCallException extends Exception {}

    String node = "DExceptionVar";
    String _call;
    String _id;
    //List<String> _throws;
    String _returns;
    ...
    public DExceptionVar() {
        //this._call = "";
        this.node = "DExceptionVar";
        this._id = "null";
        this._returns = null;
    }

    public DExceptionVar(IVariableBinding variableBinding) {
