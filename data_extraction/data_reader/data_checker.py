...
def data_checker(_clargs):
    ...
    for i in range(NUM_DATA):
        ...
        if clargs.decode_type == "alldata":
            prog_mapper.decode_paths(i, partial=False)
        elif clargs.decode_type == "prodrules":
            prog_mapper.decode_paths_as_productions(i)
        print()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--decode_type', required=True, choices=["prodrules", "alldata"])
