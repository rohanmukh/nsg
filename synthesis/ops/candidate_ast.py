...
from program_helper.ast.ops import CHILD_EDGE, Node, DAPIInvoke, DVarDecl, DClsInit, DVarAssign, DBranch, \
    ...
    MAJOR_CONCEPTS, CONTROL_FLOW_NAMES, SIBLING_EDGE, DVarDeclCls, DVarAccessDecl
import numpy as np
...
CONCEPT_NODE, API_NODE, TYPE_NODE,\
        CLSTYPE_NODE, VAR_NODE, VAR_DECL_NODE,\
             OP_NODE, METHOD_NODE, SYMTAB_MOD = 0, 1, 2, 3, 4, 5, 6, 7, 8
...
class Candidate_AST:
    ...
    def resolve_node_type(self, value):
        ...
        elif self.next_node_type == VAR_DECL_NODE:
            node = DVarAccessDecl(val=value)
